...
CUSTOM_ERROR_HANDLERS = (
    ...
    ('handle404', 'moviereviews_generic.handlers.handle404'),
    ('handle500', 'moviereviews_generic.handlers.handle500')
    )
...
TEMPLATE_DIRS = (
    resource_filename('moviereviews_generic', 'templates'),
    resource_filename('blogengine', 'templates')
)

ROOT_URLCONF = 'moviereviews_generic.config.urls'
MIDDLEWARE_CLASSES = ()
